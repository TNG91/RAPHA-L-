...
# dériver vers \[ \] ou \( \) malgré la consigne. Streamlit (KaTeX) ne
# rend que $...$ et $$...$$ : on convertit donc ces formats au passage,
# et on retire \tag{} qui n'est pas supporté par le moteur de rendu.
        ...
        with requests.post(
            ...
            for line in r.iter_lines():
                ...
                try:
                    ...
                    if delta:
                        yield fix_latex_delimiters(delta)
